...
const accordionData = [
  {
    ...
    answer: (
      <>
        ...
        <ul>
          <li>
            <i className="fa-solid fa-circle text-[0.7rem]"></i> Your body releases an <b>egg from your ovaries</b> – we’re talking
            teeny tiny eggs here; you can’t see them with the naked eye, they’re
            that small!
          </li>
          <li>
          <i className="fa-solid fa-circle text-[0.7rem]"></i> In order for the egg to be released, it has to be <b>matured</b>,
            which is a job for our hormones.
          </li>
          <li>
          <i className="fa-solid fa-circle text-[0.7rem]"></i> These hormones are also responsible for{" "}
        ...
        <a href="">
          <i><p className="underline text-pink-500 mt-8">
